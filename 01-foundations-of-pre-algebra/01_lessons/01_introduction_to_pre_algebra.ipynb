 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "        retake = input(\"Would you like to reset and restart the lesson? (yes/no): \").lower().strip()\n",
    "        if retake != 'yes':\n",
    ...
    "    else:\n",
    "        continue_lesson = input(\"Would you like to continue where you left off? (yes/no): \").lower().strip()\n",
    "        if continue_lesson != 'yes':\n",
    "            print(\"Exiting the lesson. You can run this notebook again if you change your mind.\")\n",
    "            import sys\n",
    "            sys.exit()\n",
    "\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "    score = 0\n",
    "    reset_progress(user_id, courses=[course_name], lessons=[lesson_name])\n",
    "    print(\"Progress reset. To retake the lesson, please restart the notebook or run all cells again.\")\n",
    ...
    "\n",
    "reset_button = widgets.Button(description=\"Reset Lesson\")\n",
    "reset_button.on_click(reset_lesson)\n",
    "reset_text = widgets.HTML(\"<p>If you want to improve your score, you can reset and retake the lesson:</p>\")\n",
    "\n",
    "display(HTML(f\"<h3>Your score: {final_score}%</h3>\"))\n",
    "display(save_button, save_output)\n",
    "display(reset_text)\n",
