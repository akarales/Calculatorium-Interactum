...
subdirs = ['lessons', 'quiz_book', 'reinforcement_workbook', 'midterm_exam', 'final_exam', 'interactive_visualizations', 'use_cases']
...
for course in data['courses']:
    ...
    template_path = os.path.join(course['directory'], 'lessons', 'lesson_template.ipynb')
    ...
    use_case_path = os.path.join(course['directory'], 'use_cases', 'use_case_template.ipynb')
    ...
    viz_placeholder_path = os.path.join(course['directory'], 'interactive_visualizations', 'dynamic_plots.py')
...
print("Course structure creation complete with advanced features and use cases!")